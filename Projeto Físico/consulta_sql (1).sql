...
-- NOME DOS FUNCIONARIOS QUE NÃO SÃO RESPONSÁVEIS POR NENHUMA SALA (JUNÇÃO EXTERNA A DIREITA)
SELECT  F.NOME, S.NUMERO  AS SALA
FROM SALA S RIGHT OUTER JOIN FUNCIONARIO F ON F.CPF = S.CPF
WHERE S.CPF IS NULL;
...
-- NOME DOS FUNCIONARIOS QUE TEM O MESMO CHEFE E SALARIO QUE O FUNCIONARIO 0112 (SUBCONSULTA LINHA)
